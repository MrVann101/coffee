...
public class ProductRepository {
    ...
    public ProductRepository() {
        if (products.isEmpty()) {
            ...
            products.add(new Product("5", "Espresso Shot", 95.0, "Coffee", "/com/example/project4/Images/Espresso Shot (2).jpeg", 0));
            ...
            products.add(new Product("18", "Salted Caramel Cold Brew", 150.0, "Coffee", "/com/example/project4/Images/Salted Caramel Cold Brew.jpeg", 0));

// Non-Coffee
            products.add(new Product("6", "Classic Milk Tea", 110.0, "Non-Coffee", "/com/example/project4/Images/Classic milk tea.jpeg", 0));
            products.add(new Product("7", "Matcha Green Tea Latte", 130.0, "Non-Coffee", "/com/example/project4/Images/matcha.jpeg", 0));
            products.add(new Product("8", "Taro Milk Tea", 115.0, "Non-Coffee", "/com/example/project4/Images/Taro Milk Tea.jpeg", 0));
            products.add(new Product("9", "Strawberry Smoothie", 125.0, "Non-Coffee", "/com/example/project4/Images/homepage.jpg", 0));
...
// Pastry
            ...
            products.add(new Product("13", "Berry Moofeen", 95.0, "Pastry", "/com/example/project4/Images/Berry Moofeen.jpeg", 0));
