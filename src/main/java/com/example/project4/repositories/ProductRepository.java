...
public class ProductRepository {
    ...
    private void seedSampleDataIfEmpty() {
        if (getAllProducts().isEmpty()) {
            ...
            addProduct(new Product("5", "Espresso Shot", 95.0, "Coffee", "/com/example/project4/Images/default.jpg", 0));
            ...
            addProduct(new Product("9", "Strawberry Smoothie", 125.0, "Non-Coffee", "/com/example/project4/Images/", 0));
